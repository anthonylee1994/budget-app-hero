    ...
    return (
        <div className="bg-gray-50 dark:bg-gray-800">
            <div className="mx-auto max-w-5xl p-5 py-10 text-center md:pb-20">
                ...
                <div className="mb-4 text-3xl font-bold text-gray-900 dark:text-white md:text-4xl">為什麼選擇我們？</div>
                <div className="text-md mb-8 text-gray-600 dark:text-gray-400 md:text-lg">我們提供全方位的財務管理解決方案，幫助您輕鬆掌控每一筆收支，實現財務目標。</div>
                <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 text-gray-900 dark:text-gray-100 sm:grid-cols-2 lg:grid-cols-3">
