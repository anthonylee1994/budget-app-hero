    ...
    return (
        <div className="flex flex-col items-center justify-between pb-5 pt-10">
            <div className="mb-4 flex cursor-pointer items-center gap-1" onClick={() => navigate("/")}>
                <Icon icon="fa-solid:wallet" className="mr-2 select-none text-4xl text-primary-500" />
                <span className="select-none text-4xl font-light text-primary-500">智慧理財</span>
            </div>
