...
export const Banner = () => {
    return (
        <div className="relative overflow-hidden bg-gradient-to-r from-gray-900 to-gray-800 py-5">
            <div className="mx-auto flex max-w-5xl flex-col items-center justify-center p-4 md:justify-between md:p-0 lg:flex-row">
                <div className="flex flex-col items-center p-2 text-center md:p-10 lg:max-w-[550px] lg:items-start lg:text-left">
                    ...
                    <div className="text-4xl font-bold text-white md:text-5xl">
                        ...
                        <div className="mb-2 text-blue-400">輕鬆管理每一筆收支</div>
                    </div>
                    <div className="mb-8 mt-4 text-lg text-gray-300">使用我們的智慧預算應用程式，讓您輕鬆追蹤收入與支出，制定明智的財務決策，實現財務自由。</div>
                ...
                <div className="p-10">
                    <div className="flex h-[300px] w-[300px] items-center justify-center rounded-full border-2 border-blue-500 bg-gray-900">
